...
include(Tools.cmake)
my_ctest_setup()
include(CTestConfigLibFlukso.cmake)
# set(_ctest_type "Nightly")
# set(_ctest_type "Continuous")
set(_ctest_type "Coverage")

set(URL "https://github.com/mysmartgrid/libflukso.git")
...
configure_ctest_config(${KDE_CTEST_VCS_REPOSITORY} "CTestConfigLibFlukso.cmake")
kde_ctest_setup()
